 ...
 <nav>
    ...
    <div id = "catalogo">
        ...
        <div id="filter">
            ...
            <div class="filter_box" id="KmDiv">
                Km-effettuati: <select id="Km" onchange="SelectAnno()" >
                <option disabled selected value> -- select an option -- </option></select>
            </div>
            ...
            <div class="filter_box" id="AnnoDiv">
                Anno: <select id="Anno" value="">
                <option disabled selected value> -- select an option -- </option></select>
            </div>
            <br>
...
$.post("http://localhost:8080/DriverShowcase/Logout",{},function(data){
	...
	$(document).ready(function(){
	$.post("http://localhost:8080/DriverShowcase/CreazioneCatalogo",{tipo:"Auto"},function(data){
		$("#result").html(data);
...
//FUNZIONI FILTRO
	$(document).ready(function(){
		  $.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "1","TipoFilter":"Auto"},function(data){
			  $("#Marca").html(data);
		  });
		});
	function SelectModello(){
		...
		var Marca=$( "#Marca option:selected" ).text();
		  $.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "2","TipoFilter":"Auto","Marca":  Marca },function(data){
			  $("#Modello").html(data);
	...
	function SelectKm(){
	  	  ...
	  	  $.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "3","TipoFilter":"Auto","Modello":  Modello },function(data){
	  		  $("#Km").html(data);
	...
	function SelectAnno(){
	  	  ...
	  	  $.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "4","TipoFilter":"Auto","Modello":  Modello, "Marca": Marca, "Km": Km },function(data){
	  		 $("#Anno").html(data);
		...
		if(Marca!=(" -- select an option -- "))
			{
	        	...
	        	$.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "5","TipoFilter":"Auto","Modello":  Modello, "Marca": Marca, "Km": Km, "Anno": Anno, "Prezzo": Prezzo},function(data){
	      		$("#result").html(data);
	      		});
	        }
	  	  else
	  		{
	  	    	var Prezzo=$("#FasciaDiPrezzo option:selected").text();
	  	    	$.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro":"6","TipoFilter":"Auto","Prezzo": Prezzo},function(data){
	  	    	$("#result").html(data);	
	  	    	});

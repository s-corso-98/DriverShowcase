...
$(document).ready(function(){
	$.post("http://localhost:8080/DriverShowcase/CreazioneCatalogo",{tipo:"Moto"},function(data){
		$("#result").html(data);
	});
	});
...
//FUNZIONI FILTRO
$(document).ready(function(){
	  $.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "1","TipoFilter":"Moto"},function(data){
		  $("#Marca").html(data);
	  });
	});
...
$.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "2","TipoFilter":"Moto","Marca":  Marca },function(data){
	  $("#Modello").html(data);
...
function SelectKm(){
	...
	var Modello=$( "#Modello option:selected" ).text();
	  ...
	  $.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "3","TipoFilter":"Moto","Modello":  Modello },function(data){
		  $("#Km").html(data);
...
function SelectAnno(){
	...
	var Km=$( "#Km option:selected" ).text();
	  ...
	  $.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "4","TipoFilter":"Moto","Modello":  Modello, "Marca": Marca, "Km": Km },function(data){
		 $("#Anno").html(data);
...
function Cerca(){
	...
	if(Marca!=(" -- select an option -- "))
    	...
    	$.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro": "5","TipoFilter":"Moto","Modello":  Modello, "Marca": Marca, "Km": Km, "Anno": Anno, "Prezzo": Prezzo},function(data){
  		$("#result").html(data);
  		});
    }
	  else
		{
	    	var Prezzo=$("#FasciaDiPrezzo option:selected").text();
	    	$.post("http://localhost:8080/DriverShowcase/Filtri",{"Filtro":"6","TipoFilter":"Moto","Prezzo": Prezzo},function(data){
	    	$("#result").html(data);	
	    	});
